...
export function PromptBar({
  ...
  onOpenSettings: () => void;
  onOpenStoryboardGenerator: () => void;
}) {
  ...
  return (
    <div className="prompt-bar-wrapper">
      <div className="prompt-bar" onKeyDown={(e) => e.stopPropagation()}>
        ...
        <button
          className="prompt-bar-button"
          aria-label="Storyboard Generator"
          title="Storyboard Generator"
          onClick={onOpenStoryboardGenerator}
          disabled={isGenerating}>
          <svg
            width="22"
            height="22"
            ...
            fill="currentColor">
            <path d="m80-80 160-160h560q33 0 56.5-23.5T880-320v-480q0-33-23.5-56.5T800-880H160q-33 0-56.5 23.5T80-800v720Zm80-80h474L240-554v394Zm560-640v480H292l428-480ZM219-690l106-106-22-21-106 106 22 21Zm181 0 106-106-22-21-106 106 22 21Zm181 0 106-106-22-21-106 106 22 21ZM80-80v-720 720Z" />
          </svg>
        </button>
        <button
          className="prompt-bar-button"
